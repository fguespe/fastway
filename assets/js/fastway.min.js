...
jQuery(document).ready( function(jQuery) {
  if (jQuery(".woocommerce-variation-price").text().length == 0) {
    //Oculto elp recio de arriba en los variables
    jQuery('.product-type-variable .summary .precioproducto').hide();
  }   
	applySearch("desktop");
	applySearch("mobile");
  ...
  //var hoverTimeout;
//Megamenu/Desktop
  jQuery('#fw-menu li').hover(function() {
      jQuery(this).find('.dropdown-menu').show();
  });
  jQuery('#fw-menu li').mouseleave(function() {
    jQuery(this).find('.dropdown-menu').hide();
});
  jQuery('#fw-menu').hover(function() {
    jQuery('.submenu-overlay').addClass('active');

  });
  jQuery('#fw-menu').mouseleave(function() {
