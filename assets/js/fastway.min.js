...
jQuery(document).ready( function(jQuery) {
  ...
  jQuery('#menu-madre li').hover(function() {
      jQuery(this).find('.submenu-madre').show();
      jQuery('.submenu-overlay').addClass('active');

  });
  jQuery('#menu-madre li').mouseleave(function() {
      jQuery(this).find('.submenu-madre').hide();
