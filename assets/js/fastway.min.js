  ...
  setInterval(function() {
      ...
      if (jQuery('.single_variation_wrap span.price').length !== 0) {
        if (jQuery('.single_variation_wrap span.price').text() !== variable_product_price[0]) {
              variable_product_price = jQuery('.woocommerce-variation-price span.price');
              let jaj=variable_product_price[0]
              console.log('jaja',jQuery('.fw_single_product .summary span.price'))
              jQuery('.fw_single_product .summary span.price').html('<span class="price">jeje</span>');
          }
      }
  }, 500);
}
