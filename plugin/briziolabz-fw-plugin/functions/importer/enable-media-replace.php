<?php
/*
Plugin Name: Importer Nubimedia eCommerce
Plugin URI: http://www.nubi.media
Description: NUBIMEDIA
Version: 1
Author: Fabrizio Guespe
Author URI: http://www.nubi.media
...
function enable_media_replace( $form_fields, $post ) {
	...
	$action = "media_replace";
  	$editurl = $url;//wp_nonce_url( $url, $action );
