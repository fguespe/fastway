...
function fw_loop_image(){
    ...
    if(empty($image))$image='<img width="300" height="300" src="/wp-content/uploads/sites/12/woocommerce-placeholder.png" class="woocommerce-placeholder wp-post-image" alt="Marcador" loading="lazy">';
