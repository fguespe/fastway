...
function fw_event_url(){
  ...
  if(function_exists('get_field') && get_field('file',$fw_loop_event->ID))echo '<a href="'.get_field('file',$fw_loop_event->ID).'" class="" target="_blank" ><i class="fal fa-download"></i></a>';
}
