...
function fw_event_url(){
  ...
  if(function_exists('get_field') && get_field('replay_webinar',$fw_loop_event->ID))echo '<a style="margin-left:6px;color:var(--main);" href="'.get_field('replay_webinar',$fw_loop_event->ID)['replay_webinar'].'" class="" target="_blank" ><i class="fal fa-repeat"></i> Replay</a>';
}
