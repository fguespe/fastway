...
if ( ! function_exists( 'fw_scripts' ) ) {
	function fw_scripts() {
		...
		wp_enqueue_script( 'mmenu-script', get_template_directory_uri() . '/assets/js/mmenu-light.js'  );
		wp_enqueue_style( 'mmenu-styles', get_template_directory_uri() . '/assets/css/mmenu-light.css');
