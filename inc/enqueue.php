...
if ( ! function_exists( 'fw_scripts' ) ) {
	function fw_scripts() {
		...
		wp_enqueue_style( 'awesome-style', 'https://pro.fontawesome.com/releases/v5.7.0/css/all.css');
		//wp_enqueue_style( 'awesome-style', 'https://use.fontawesome.com/releases/v5.7.1/css/all.css');
