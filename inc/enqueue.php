...
if ( ! function_exists( 'fw_scripts' ) ) {
	function fw_scripts() {
		...
		//wp_enqueue_style( 'swiper-styles', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.4.1/css/swiper.min.css');
		...
		//wp_enqueue_script( 'swiper-scripts', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.4.1/js/swiper.min.js', array(), true );
