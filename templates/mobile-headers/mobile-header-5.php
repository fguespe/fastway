...
?>
<div id="mobileicons" class="<?php echo esc_attr( $header_middle_mobile ); ?>  d-flex flex-row-reverse" style="background: var(--middle-header);"><?php if(fw_theme_mod('fw-quicklinks'))quicklinks();?></div>
<div class="<?php echo esc_attr( $header_middle_mobile ); ?> ">
      <div class="col-2 " style="padding: 0px;"><?php echo fastway_getLogo();?></div>
      <div class="col-8 align-items-center" style="padding: 0px;"></div>
