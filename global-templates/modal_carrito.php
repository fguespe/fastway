...
function populatecart(){
    ...
    function (datos) { 
        ...
        jQuery.each(datos['cart'], function (index, value) {
            ...
            jqe+='<div class="row d-flex justify-content-between no-gutters item-cantidad " id="loadinghide_'+index+'">'
            ...
            jqe+='<input  type="text" style="width:20px;" id="qty_'+index+'" name="quantity" class="input-number" value="'+value['quantity']+'" min="1" max="100">'
