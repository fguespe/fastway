...
add_filter('woocommerce_email_subject_customer_on-hold_order', 'woocommerce_email_subject_customer_on_hold_order', 1, 2);
function woocommerce_email_subject_customer_on_hold_order( $subject, $order ) {
    return get_option('fw_email_subject_customer_on-hold_order');
}

$html =get_option('fw_email_content_customer_on-hold_order');
