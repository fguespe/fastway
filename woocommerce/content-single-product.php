...
function fw_single_title(){
    ...
    if('yes' === get_option( 'woocommerce_enable_reviews'))echo '<div class="rating" >'.fw_getfastars($product->get_average_rating()).'<a class="title_reviews" href="#reviews">'.__('Reviews','woocommerce').' </a></div>';
}
